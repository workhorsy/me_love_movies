...
describe "/title_ratings/new.html.erb" do
  include TitleRatingsHelper
  
  before(:each) do
    @title_rating = mock_model(TitleRating)
    @title_rating.stub!(:new_record?).and_return(true)
  ...
  it "should render new form" do
    render "/title_ratings/new.html.erb"
    
    response.should have_tag("form[action=?][method=post]", title_ratings_path) do
